	...
	return (
		<div className="pt-20 pb-5 px-5 flex flex-row justify-center  h-screen bg-dollarBill  ">
			<div className="flex py-10 px-10 h-full w-full rounded-2xl bg-bone justify-center items-center">
				<div className="flex flex-col  h-full w-1/2 py-10 px-10 bg-snow rounded-l-2xl border-4 border-jet  ">
                    <div className="flex h-1/6 w-full justify-evenly">
                        <DropDownSelect selectOption={player1} setSelectOption={setPlayer1} options={players} />
                        <DropDownSelect selectOption={player1} setSelectOption={setPlayer1} options={players} />
                    </div>
                    <div className="flex flex-col items-center h-full w-full bg-jet">
                        
                        
                        <div className="w-full h-full bg-dollarBill"></div>
                    </div>
					
				</div>
                <div className="flex flex-col  h-full w-1/2 py-10 px-10 bg-snow border-t-4 border-r-4 border-b-4 rounded-r-2xl   ">
                <div className="flex h-1/6 w-full justify-evenly">
                        <DropDownSelect selectOption={player2} setSelectOption={setPlayer2} options={players} />
                        <DropDownSelect selectOption={player2} setSelectOption={setPlayer2} options={players} />
                    </div>
                    <div className="flex flex-col items-center h-full w-full bg-jet">
